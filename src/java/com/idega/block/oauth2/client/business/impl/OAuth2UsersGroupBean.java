...
public class OAuth2UsersGroupBean extends DefaultSpringBean implements
	...
	protected GroupHome getGroupHome() {
		if (this.groupHome == null) {
			try {
				...
				getLogger().log(Level.WARNING, "Unable to get " + GroupHome.class, e);
			}
		}
	...
	protected GroupBusiness getGroupBusiness() {
		if (this.groupBusiness == null) {
			try {
				this.groupBusiness = getServiceInstance(GroupBusiness.class);
			} catch (Exception e) {
				getLogger().log(Level.WARNING, "Unable to get " + GroupBusiness.class, e);
			}
		}
