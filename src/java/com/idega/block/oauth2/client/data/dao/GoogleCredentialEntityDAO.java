...
/**
 * <p>Data access object for {@link GoogleCredentialEntity}.</p>
 ...
 */
public interface GoogleCredentialEntityDAO extends GenericDao, com.google.api.client.auth.oauth2.CredentialStore {
	public static final String BEAN_NAME = "googleCredentialEntityDAO";
	 ...
	 * @param clientId
	 * @param clientSecret
	 * @param googleUserId TODO
	 * @return
	 * @author <a href="mailto:martynas@idega.com">Martynas Stakė</a>
	 */
	public GoogleCredentialEntity update(Long id, Long expirationTimeMillis,
			String refreshToken, String accessToken, User user,
			String clientId, String clientSecret, String googleUserId);
